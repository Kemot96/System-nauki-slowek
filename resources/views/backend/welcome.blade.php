                ...
                <div class="top-right links">
                    ...
                    @if(\Auth::user()->is("Administrator") || \Auth::user()->is("Redaktor") || \Auth::user()->is("Super Redaktor"))
                        @if(\Auth::user()->is("Administrator"))
                            ...
                            <a href="{{ route('subcatRoles.index') }}"  class="btn btn-primary">Podkategorie dla ról</a>
                        @endif
                    ...
                    @endif
                        <a href="{{ url('/frontwelcome') }}" class="btn btn-primary">Front-end</a>
                        <a href="{{ url('/home') }}">Home</a>
                    @else
                        <a href="{{ url('/frontwelcome') }}" class="btn btn-primary">Przejdź dalej</a>
